...
SYMBOL = "ETHUSDT"
OUTPUT_FILE = Path("5-min-ETH.csv")
...
def main():
    ...
    all_rows, seen, earliest = load_existing(OUTPUT_FILE)
    ...
    print(f"Added {new_rows} new rows; wrote {len(all_rows)} rows to {OUTPUT_FILE.name}")
