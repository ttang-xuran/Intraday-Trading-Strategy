...
OUTPUT_IMAGE = Path("intraday_trend_multi_equity_2025_capital.png")
...
def main() -> None:
    ...
    ax.set_title("Intraday Trend Strategy Capital Curves (2025, 00K start)")
    ...
    print(f"Saved 2025 capital curve comparison to {OUTPUT_IMAGE}")
